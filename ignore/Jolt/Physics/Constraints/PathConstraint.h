...
#include "../Constraints/PathConstraintPath.h"
#include "../Constraints/MotorSettings.h"
#include "../Constraints/ConstraintPart/AxisConstraintPart.h"
#include "../Constraints/ConstraintPart/DualAxisConstraintPart.h"
#include "../Constraints/ConstraintPart/HingeRotationConstraintPart.h"
...
public:
	...
	{
		JPH_ASSERT(inState == EMotorState::Off || mPositionMotorSettings.IsValid());
		mPositionMotorState = inState;
	}
	...
	{
		JPH_ASSERT(mPath->IsLooping() || (inFraction >= 0.0f && inFraction <= mPath->GetPathMaxFraction()));
		mTargetPathFraction = inFraction;
	}
