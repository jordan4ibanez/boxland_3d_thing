...
! typedef void JPH_QueueJobsCallback(void* context, JPH_JobFunction* job, void** args, uint32_t count)
  ...
  interface
    ...
    function JPH_PhysicsSystem_GetBodyInterfaceNoLock(system) result(BodyInterface) bind(c, name = "JPH_PhysicsSystem_GetBodyInterfaceNoLock")
      use, intrinsic :: iso_c_binding
      implicit none
    ...
    function JPH_PhysicsSystem_GetBodyLockInterfaceNoLock(system) result(BodyLockInterface) bind(c, name = "JPH_PhysicsSystem_GetBodyLockInterfaceNoLock")
      use, intrinsic :: iso_c_binding
      implicit none
...
! JPH_CAPI void JPH_PhysicsSystem_DrawConstraintReferenceFrame(JPH_PhysicsSystem* system, JPH_DebugRenderer* renderer)
    ...
    subroutine JPH_Quaternion_FromTo(fromvec3, toquat) bind(c, name = "JPH_Quaternion_FromTo")
      use, intrinsic :: iso_c_binding
      implicit none
    ...
    subroutine JPH_PhysicsMaterial_Destroy(material) bind(c, name = "JPH_PhysicsMaterial_Destroy")
      use, intrinsic :: iso_c_binding
      implicit none
