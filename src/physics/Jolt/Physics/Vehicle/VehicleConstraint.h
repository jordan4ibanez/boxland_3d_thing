...
#include "../Vehicle/VehicleAntiRollBar.h"
...
public:
	...
	{
		mGravityOverride = inGravity;
		mIsGravityOverridden = true;
	}
	...
	{
		mIsGravityOverridden = false;
		mBody->GetMotionProperties()->SetGravityFactor(1.0f);
