...
public:
	...
	{
		mLimitMin[inAxis] = -FLT_MAX;
		mLimitMax[inAxis] = FLT_MAX;
	}
	...
	{
		mLimitMin[inAxis] = inMin;
		mLimitMax[inAxis] = inMax;
	}
...
public:
	...
	{
		JPH_ASSERT(inAxis < EAxis::NumTranslation);
		return mLimitsSpringSettings[inAxis];
	}
	void SetLimitsSpringSettings(EAxis inAxis, const SpringSettings &inLimitsSpringSettings)
	{
		JPH_ASSERT(inAxis < EAxis::NumTranslation);
		mLimitsSpringSettings[inAxis] = inLimitsSpringSettings;
