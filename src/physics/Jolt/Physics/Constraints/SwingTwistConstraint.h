...
#include "../Constraints/MotorSettings.h"
#include "../Constraints/ConstraintPart/PointConstraintPart.h"
#include "../Constraints/ConstraintPart/AngleConstraintPart.h"
#include "../Constraints/ConstraintPart/SwingTwistConstraintPart.h"
...
public:
	...
	inline void SetNormalHalfConeAngle(float inAngle)
	{
		mNormalHalfConeAngle = inAngle;
		UpdateLimits();
	}
	inline float GetPlaneHalfConeAngle() const { return mPlaneHalfConeAngle; }
	inline void SetPlaneHalfConeAngle(float inAngle)
	{
		mPlaneHalfConeAngle = inAngle;
		UpdateLimits();
	}
	inline float GetTwistMinAngle() const { return mTwistMinAngle; }
	inline void SetTwistMinAngle(float inAngle)
	{
		mTwistMinAngle = inAngle;
		UpdateLimits();
	}
	inline float GetTwistMaxAngle() const { return mTwistMaxAngle; }
	inline void SetTwistMaxAngle(float inAngle)
	{
		mTwistMaxAngle = inAngle;
		UpdateLimits();
	}
