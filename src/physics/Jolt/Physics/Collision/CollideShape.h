...
#include "../Collision/BackFaceMode.h"
#include "../Collision/ActiveEdgeMode.h"
#include "../Collision/CollectFacesMode.h"
...
public:
	...
	/// Constructor
	CollideShapeResult(Vec3Arg inContactPointOn1, Vec3Arg inContactPointOn2, Vec3Arg inPenetrationAxis, float inPenetrationDepth, const SubShapeID &inSubShapeID1, const SubShapeID &inSubShapeID2, const BodyID &inBodyID2) : mContactPointOn1(inContactPointOn1),
