...
#define JPH_PROFILE_START(name)         \
	do                                    \
	{                                     \
		Profiler::sInstance = new Profiler; \
...
#define JPH_PROFILE_END()          \
	...
	{                                \
		...
		delete Profiler::sInstance;    \
		Profiler::sInstance = nullptr; \
	} while (false)
...
#define JPH_PROFILE_THREAD_START(name)                      \
	do                                                        \
	{                                                         \
		if (Profiler::sInstance)                                \
			ProfileThread::sSetInstance(new ProfileThread(name)); \
	} while (false)
...
#define JPH_PROFILE_THREAD_END()          \
	do                                      \
	{                                       \
		delete ProfileThread::sGetInstance(); \
		ProfileThread::sSetInstance(nullptr); \
	} while (false)
